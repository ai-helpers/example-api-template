report-types: ## Generate the project mypy type report.
	poetry run mypy src/api_example/ tests/ > reports/mypy.txt || true
...
report-quality: ## Generate the project quality report.
	poetry run ruff check --output-format=json --output-file=reports/ruff.json src/api_example/ tests/ || true

report-security: ## Generate the project security report.
	poetry run bandit --recursive --format=json --output=reports/bandit.json src/api_example/ || true
